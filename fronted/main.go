...
import (
	...
	"FlashSaleSystem/common"
	"FlashSaleSystem/fronted/middleware"
	"FlashSaleSystem/fronted/web/controllers"
	"FlashSaleSystem/repositories"
	"FlashSaleSystem/services"

	"FlashSaleSystem/rabbitmq"
)
